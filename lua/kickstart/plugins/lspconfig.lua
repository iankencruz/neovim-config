		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					-- NOTE: Switched from vim.lsp.buf to fzf-lua for a better UI selector.
					...
					--  NOTE: 'lsp_live_workspace_symbols' is the direct equivalent to Telescope's
					--  'dynamic_workspace_symbols' (queries LSP as you type).
